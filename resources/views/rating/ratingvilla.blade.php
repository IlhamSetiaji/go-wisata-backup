                    ...
                    <div id="review_form_wrapper">
                        <div id="review_form">
                            ...
                            <div id="respond" class="comment-respond">
                                @foreach (App\Models\ReviewVilla::where('kode_tiket', $dt->kode_tiket)->get() as $r)
                                    <form action="/create_ratingvilla/{{ $r->id }}" method="POST" id="commentform"
                                        class="comment-form">
                                        @csrf
                                        <div class="comment-form-rating">
                                            <p class="stars">
                                                <input type="hidden" name="villa_id" value="{{ $dt->id_produk }}">
