                    ...
                    <div id="review_form_wrapper">
                        <div id="review_form">
                            ...
                            <div id="respond" class="comment-respond">
                                @foreach (App\Models\ReviewEvent::where('kode_tiket', $dt->kode_tiket)->get() as $r)
                                    <form action="/create_ratingevent/{{ $r->id }}" method="POST" id="commentform"
                                        class="comment-form">
                                        @csrf
                                        <div class="comment-form-rating">
                                            <p class="stars">
                                                <input type="hidden" name="event_id" value="{{ $dt->id_produk }}">
