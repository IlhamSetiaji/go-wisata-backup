                    ...
                    <div id="review_form_wrapper">
                        <div id="review_form">
                            ...
                            <div id="respond" class="comment-respond">
                                @foreach (App\Models\ReviewTempatSewa::where('kode_tiket', $dt->kode_tiket)->get() as $r)
                                    <form action="/create_ratingtempatsewa/{{ $r->id }}" method="POST"
                                        id="commentform" class="comment-form">
                                        @csrf
                                        <div class="comment-form-rating">
                                            <p class="stars">
                                                @php
                                                    $data = App\Models\Ruang::where('id', $dt->id_produk)->pluck('tempatsewa_id');
                                                    $tempatsewa = App\Models\TempatSewa::where('id', $data)->first();
                                                @endphp
                                                <input type="hidden" name="tempatsewa_id" value="{{ $tempatsewa->id }}">
                                                <input type="hidden" name="kode_tiket" value="{{ $dt->kode_tiket }}">
                                        ...
                                        <p class="comment-form-comment">
                                            ...
                                            <label>Comment as &nbsp;&nbsp;&nbsp;
                                                <input type="radio" name="nama" value="Anonymous" />Anonymous &nbsp;
