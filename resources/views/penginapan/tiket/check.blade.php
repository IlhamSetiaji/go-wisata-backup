                    ...
                    <div class="col-lg-7">
                        <div class="card widget-todo">
                            ...
                            <table class="table table-hover" id="admin">
                                ...
                                <tbody <tr>
                                    <td class="col-5">Reservasi {{ $db->name }}</td>
                                        ...
                                        <td class="col-10">
                                            @if (!$pay == null)
                                                @if ($pay->status_message == 'settlement')
                                                    @if ($ck == 0)
                                                        Berhasil Dibayar
                                                        <a href="{{ route('update.kedatanganp', [$id]) }}"><button
                                                                class="btn btn-outline-success"> Check In</button></a>
                                                    @elseif ($ck == 1)
                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                        <a href="{{ route('update.kedatanganp2', [$id]) }}"><button
