            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        @if ($tempat->open == 1)
                            <a href="{{ route('update.status.tempat.event', [$tempat->id]) }}"><button
                                    class="btn btn-warning"> Buka</button></a>
                        @else
                            <a href="{{ route('update.status.tempat.event', [$tempat->id]) }}"><button
                                    class="btn btn-danger"> Tutup</button></a>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="card-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form form-horizontal" action="{{ route('update.data.tempat.event', [$tempat->id]) }} "
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="name" class="form-control" name="name" placeholder="Name"
                                                    id="name" value="{{ $tempat->name }}" required>
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="email" class="form-control" name="email"
                                                    placeholder="Email" id="email" value="{{ $tempat->email }}"
                                                    required>
                                                <div class="form-control-icon">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-lefts">
                                                <div class="position-relative">
                                                    ...
                                                    <input type="file" class="form-control file-upload-info @error('image2') is-invalid @enderror"  "
