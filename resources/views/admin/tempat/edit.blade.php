                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{ route('tempat.update', [$users->id]) }} "
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <textarea type="text" class="form-control" name="sejarah" id="deskripsi">
                                                         {{ $users->sejarah }}
                                                    </textarea>
                                                            <div class="form-control-icon">
                                                                <i class="fas fa-pen"></i>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <textarea type="text" class="form-control" name="lokasi" id="deskripsi">
                                                         {{ $users->lokasi }}
                                                    </textarea>
                                                            <div class="form-control-icon">
                                                                <i class="fas fa-pen"></i>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-lefts">
                                                        ...
                                                        <img alt="image" class="mr-3 rounded-circle" width="50" src="{{asset('images')}}/{{$users->image}}">
                                                            ...
                                                            <input type="file"
                                                                class="form-control file-upload-info @error('video') is-invalid @enderror" " placeholder="Upload Video" name="video">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-lefts">
                                                        ...
                                                        <img src="{{asset('images')}}/{{$users->image}}">
                                                            ...
                                                            <input type="file"
                                                                class="form-control file-upload-info @error('image') is-invalid @enderror" " placeholder="Upload Image" name="image2">
                                                        <span class="input-group-append">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                            ...
                                                            <select class="form-select" id="basicSelect"  name="user_id">
                                                             @foreach (App\Models\User::where('role_id', '!=',
                                                                '5')->where('role_id', '!=',
                                                                '9')->get() as $petugas)
