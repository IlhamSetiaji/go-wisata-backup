...
@section('title', 'Review Tempat Sewa')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Data Review Tempat Sewa</h3>
                    <p class="text-subtitle text-muted">Halaman untuk mengelola komentar/ulasan mengenai tempat sewa </p>
                </div>
            </div>
        </div>
        {!! Toastr::message() !!}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a type="button" class="btn bt-danger"
                                                                href="/reviewtempatsewa/hapus/{{ $r->id }}"
