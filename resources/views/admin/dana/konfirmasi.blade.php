...
//   $pencairan = DB::table('tb_pencairan')->where('user_id',Auth::user()->id)->OrderBy('id','DESC')->first() 
    // $pencairan = App\Models\Cair::where('user_id', Auth::user()->id)->latest()->first();
    $pencairan = App\Models\Cair::latest()->first();
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <p class="date-text text-left"
                                                                                ...
                                                                                Waktu : {{ $pencairan->tgl_pengajuan }}</p>
                                                                        </th>
                                                                    </tr>
                                                                </table>
                                                            </th>
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <p class="text-center status-text"
                                                                                ...
                                                                                <strong>Pencairan Disetujui</strong>
                                                                                    
                                                                                @elseif($pencairan->status == 2)
                                                                                <strong>Pencairan Ditolak</strong>

                                                                                @else
                                                                                    
                                                                                @endif
                                                                                
                                                                                {{-- <strong>Konfirmasi Pencairan</strong> --}}
                                                                            </p>
                                                                        </th>
                                                                        <th class="expander"
                                                                            style="Margin:0;color:#0a0a0a;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:19px;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
                                                        ...
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                                ...
                                                                <p
                                                                    ...
                                                                    <br /><br />
                                                                    Hai, Super admin Pengajuan pencairan dilakukan oleh, {{ $pencairan->petugas->name }}</p>
                                                            </th>
                                                            <th class="expander"
                                                                style="Margin:0;color:#0a0a0a;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:19px;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
                                                            </th>
                                                                ...
                                                                <table class="order-details" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            Rp. {{ number_format($pencairan->jumlah) }}</td>
                                                                    </tr>
                                                                    <tr
                                                                        style="padding:0;text-align:left;vertical-align:top">
                                                                        <td
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            Rp. {{ number_format($pencairan->jumlah) }}</td></td>
                                                                    </tr>
                                                                </table>
                                                            </th>
                                                            <th class="expander"
