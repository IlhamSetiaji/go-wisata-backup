                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover" id="tempat">
                        ...
                        <tbody @foreach ($cair as $data) <tr>
                            ...
                            <td class="col-6 ">
                                @if ($data->status == '0')
                                <a href="{{ route('penolakan.dana', [$data->id]) }}"><button class="btn btn-danger">
                                        Tolak </button></a>
                                <a href="{{ route('konfirmasi.dana', [$data->id]) }}"><button class="btn btn-warning">
                                        Konfirmasi </button></a>
                                @else
                                Disetujui
                                @endif
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <table class="table table-hover" id="tempat2">
                        ...
                        <tbody @foreach ($cair2 as $data) <tr>
                            <td class="col-3">{{ $data->petugas->name }}</td>
                            <td class="col-3 "> x {{ $data->tempat->name }}</td>
