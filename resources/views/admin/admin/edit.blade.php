                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{ route('admin.update', [$users->id]) }} "
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <select class="form-select" id="basicSelect" name="desa_id">
                                                                <option value=""
                                                                    @if ($users->desa_id == null) selected @endif>Please
                                                                    select desa </option>

                                                                @foreach (App\Models\Tempat::get()->where('kategori', 'desa') as $desad)
                                                                    <option value="{{ $desad->id }}"
                                                                        @if ($users->desa_id == $desad->id) selected @endif>
                                                                        {{ $desad->name }}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <select class="form-select" id="basicSelect"
                                                                ...
                                                                <option value=""
                                                                    @if ($users->desa_id == null) selected @endif>Please
                                                                    select tempat</option>
                                                                @foreach (App\Models\Tempat::get() as $tp)
                                                                    <option value="{{ $tp->id }}"
                                                                        @if ($users->tempat_id == $tp->id) selected @endif>
                                                                        {{ $tp->name }}</option>
                                                                @endforeach
                                                            </select>
