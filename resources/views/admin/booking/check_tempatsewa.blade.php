...
@section('title', 'Check Tempat Sewa')
@section('content')
    <header class="mb-3">
    ...
    @isset($cek)
        <div class="row">
            <div class="col-12 col-md-6 col-lg-6">
                <form action="/check_tempatsewa" method="get">
                    @csrf
                    ...
                    <div class="col-lg-7">
                        <div class="card widget-todo">
                            ...
                            <table class="table table-hover" id="admin">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="col-5">{{ $data2->name }}</td>
                                        <td class="col-2">{{ $db->durasi }}</td>
                                        <td class="col-2">{{ number_format($db->ruang->harga) }}</td>
                                        ...
                                        <td class="col-10">
                                            @if (!$pay == null)
                                                @if ($pay->status_message == 'settlement')
                                                    ...
                                                    @if ($ck == 1)
                                                        <a href="{{ route('update.status.bookingtempatsewa0', [$db->id]) }}"><button
                                                                class="btn btn-outline-primary"> Belum Check In</button></a>
                                                    @elseif ($ck == 2)
                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                        <a href="{{ route('update.status.bookingtempatsewa1', [$db->id]) }}"><button
