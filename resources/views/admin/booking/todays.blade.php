    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Pemesanan Event : {{ $today }} </h5>
                <div class="row">
            ...
            <div class="card-body">
                <a href="{{ route('print.today.event', [$today]) }}" class="btn btn-light" target="_blank">
                    Print</a>
                        ...
                        @if (count($data) > 0)
                            @foreach ($data as $key => $data)
                                <tr>
                                    ...
                                    <td>
                                        @if ($data->status == 1)
                                            <a href="{{ route('update.status.intodayck', [$data->id]) }}"><button
                                                    class="btn btn-outline-primary"> Check In</button></a>
                                        @elseif ($data->status == 2)
                                            <a href="{{ route('update.status.intodayco', [$data->id]) }}"><button
