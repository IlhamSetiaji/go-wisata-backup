...
@section('content')
    <main class="main">
        ...
        <section class="home" id="home">
            <img src="{{ asset('images') }}/{{ $villa->foto }}" alt="" class="home__img">
            <div class="home__container container grid">
                <div class="home__data">
                    <span class="home__data-subtitle">Penginapan</span>
                    <h1 class="home__data-title">{{ $villa->nama }}<br> <b>{{ $tempat->name }}</b></h1>
                    <a href="{{ url('explore-penginapan') }}" class="button">Explore</a>
                </div>
            </div>
        </section>
        </br>
                    ...
                    <div class="row">
                        <div class="col-12 col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="list-group">
                                        <li class="list-group-item" align="justify"> {{ $villa->deskripsi }}</li>
                                        <li class="list-group-item">Harga : Rp. {{ number_format($villa->harga) }} /
                                            hari
                                        </li>
                                        <li class="list-group-item">Lokasi : {{ $villa->lokasi }}</li>
                                        <li class="list-group-item">Maps : <a href="{{ $villa->maps }}"
                                                target="blank">{{ $villa->maps }}</a></li>
                                        <li class="list-group-item">Telp : {{ $villa->telp }}</li>
                                        <li class="list-group-item">Kapasitas Max : {{ $villa->kapasitas }} orang
                                        </li>
                                    </ul>
                                    </br>
                                    @php
                                                        ...
                                                        <span class="badge rounded-pill bg-light"
                                                            ...
                                                            @if ($h != null)
                                                                @if ($r->user->name == $h['name'])
                                                                    <a href="komentartempat/delete/{{ $r->id }}"><i
                                                                    ...
                                                                    <div class="modal fade text-left"
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <form
                                                                                    action="/komentartempat/update/{{ $r->id }}"
