        ...
        <div class="container">
            <section class="row">
                <div class="col-12 col-lg-9">
                    <form
                        action="/pesantiketevent/{{ $jml_orang }}/{{ $id }}/{{ $harga }}/{{ $nama_event }}/{{ $tgl_buka }}/{{ $tgl_tutup }}"
                                ...
                                <div class="col-12 col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <i class="fa fa-id-card-o"></i> Peserta {{ $i }}
                                        </div>
                                        <div class="card-body">
                                            <div class="form-group">
                                                @php
                                                    ...
                                                    $urut++;
                                                    $huruff = 'PE-';
                                                    $kode_peserta = $huruff . $urut . $i . uniqid();
                                                @endphp
                    ...
                    <div class="card">
                        ...
                        <div class="card-content pb-4">
                            <div class="recent-message d-flex px-4 py-3">
                                <p>Nama event : {{ $nama_event }}</br>
                                    Jumlah : {{ $jml_orang }} orang</br>
                                    Harga : Rp.{{ number_format($harga) }} / tiket</br>
                                    Total harga : Rp.{{ number_format($harga * $jml_orang) }}
                                </p>
                            </div>
                        </div>
                    </div>
