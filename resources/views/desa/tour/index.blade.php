                    ...
                    <div class="card-header">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-right">
                                <li class="breadcrumb-item"> <a href="{{route('tourd.show')}}" class="btn btn-outline-primary ">Tambah Tour Guide </a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            ...
                                            <div class="avatar avatar-xl">
                                                <img alt="image" class="mr-3 rounded-circle" width="50" src="{{asset('images')}}/{{$tour->foto}}">
                                            </div>
                                            @endif
                                        </td>
                                        <td>
