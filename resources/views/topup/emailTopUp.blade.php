...
<body
  ...
  <![endif]-->
  <?php $topup = DB::table('top_up')->where('user_id',Auth::user()->id)->where('keterangan','Pembayaran Sedang Diproses, Silahkan Menunggu Email Sukses Pembayaran')->OrderBy('id','DESC')->first() ?>
    <table class="body"
                                                        ...
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th
                                                                ...
                                                                <p
                                                                    ...
                                                                    {{ $topup->name }},<br /><br />
                                                                    Transaksi TOP UP Saldo anda sedang diproses silahkan menunggu Email Konfirmasi. </p>
                                                            </th>
                                                            <th class="expander"
                                                                style="Margin:0;color:#0a0a0a;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:19px;margin:0;padding:0!important;text-align:left;visibility:hidden;width:0">
                                                            </th>
