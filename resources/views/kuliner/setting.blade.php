            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        @if($tempat->open== 1)
                        <a href="{{route('update.status.tempat.kuliner',[$tempat->id])}}"><button class="btn btn-warning"> Buka</button></a>
                        @else
                        <a href="{{route('update.status.tempat.kuliner',[$tempat->id])}}"><button class="btn btn-danger"> Tutup</button></a>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <form class="form form-horizontal" action="{{route('update.data.tempat.kuliner',[$tempat->id])}} " method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                    <div class="form-body">
                        <div class="row">
