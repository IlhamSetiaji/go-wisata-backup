...
class DanaSController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // dd($grandcair);
        return view('admin.tempatsewa.dana.index', compact('data', 'duit', 'id_tempat', 'cair', 'uangutama', 'duit2', 'duit3'));
        
    }
    public function sewa_cair(Request $request)
    {
        //
        $tempat  = Tempat::where('user_id', Auth::user()->petugas_id)->where('status', '1')->first();
        $id_tempat = $tempat->id;
